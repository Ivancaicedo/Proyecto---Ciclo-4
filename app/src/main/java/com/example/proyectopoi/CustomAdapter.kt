...
class CustomAdapter (private var context: Context, private var cityNames: ArrayList<String>, private var cityContacts: ArrayList<String>, private var cityDescription: ArrayList<String>,):RecyclerView.Adapter<CustomAdapter.MyViewHolder>(){
